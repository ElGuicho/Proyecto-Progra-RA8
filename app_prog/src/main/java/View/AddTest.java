...
public class AddTest extends JFrame {
    ...
    private JSpinner correctaSpinner = new JSpinner(new SpinnerNumberModel(0, 0, 3, 1));
    ...
    public AddTest() {
        ...
        panel.add(correctaSpinner, UiUtils.gbc(1, 6, 1));

        panel.add(guardar, UiUtils.gbc(0, 7, 1));
    ...
    private void saveQuestion() {
        ...
        PreguntaTest pregunta = new PreguntaTest(0, "Anonimo", "", "", "", "", "", enunciado, LocalDate.now(), null,
                opciones, correcta);
        QuestionQuerys.addTestQuest(pregunta);
